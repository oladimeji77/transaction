...
class Vote(Base):
    __tablename__ = "votes"
    user_id = Column(Integer, ForeignKey("NewUser.id", ondelete="CASCADE"), primary_key=True)
    tranx_id = Column(Integer, ForeignKey("tranx.id", ondelete="CASCADE"), primary_key=True)
